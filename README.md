...
**👉 [超かんたん使い方ガイド（非エンジニア向け）](QUICKSTART.md)**

ステップバイステップで詳しく説明しています。プログラミング知識不要！

**👥 [共有キー版 超かんたん手順書](SHARED_KEY_QUICKSTART.md)** ← おすすめ！

管理者とメンバー向けの具体的な手順を掲載。APIキーを1回設定するだけで全員が使えます。

**🔧 [共有キー版の詳細セットアップガイド](SHARED_KEY_SETUP.md)**

セキュリティやトラブルシューティングなど、詳しい情報はこちら。
